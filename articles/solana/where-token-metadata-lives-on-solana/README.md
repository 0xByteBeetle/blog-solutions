...
| [4](published.md#block-4) | client-program | Preserved in the published block; runnable mapping pending |
| [5](published.md#block-5) | client-program | Preserved in the published block; runnable mapping pending |
