# EVM Tx — Understanding Legacy Ethereum Transactions (Type 0x0)

[Read the article](https://andreyobruchkov1996.substack.com/p/evm-tx-understanding-legacy-ethereum) · [Published examples](published.md)
...
| Block | Type | Source |
| --- | --- | --- |
| [1](published.md#block-1) | program-with-omitted-imports | Preserved in the published block; runnable mapping pending; [original repo variant](../../../examples/evm/transaction-types/account/account.go) |
| [2](published.md#block-2) | encoding-layout | Preserved in the published block; runnable mapping pending |
| [3](published.md#block-3) | illustrative-data | Preserved in the published block; runnable mapping pending |
| [4](published.md#block-4) | program | [published source](../../../examples/evm/transaction-types/legacy-tx/legacy.go); [original repo variant](../../../examples/evm/transaction-types/legacy-tx/legacy.go) |
